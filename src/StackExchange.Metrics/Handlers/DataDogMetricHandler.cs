...
{
    /// <summary>
    /// Implements <see cref="IMetricHandler"/> by sending data to DataDog.
    /// </summary>
    public class DataDogMetricHandler : IMetricHandler
    {
        ...
        private BufferedMetricHandler GetHandler()
        {
            ...
            else if (_baseUri.Scheme == Uri.UriSchemeHttp || _baseUri.Scheme == Uri.UriSchemeHttps)
            {
                if (_apiKey != null)
                {
                    handler = new JsonMetricHandler(_baseUri, _apiKey, _appKey);
                }
                else
                {
        ...
        /// </summary>
        public class JsonMetricHandler : HttpJsonMetricHandler
        {
            ...
            /// An app key.
            /// </param>
            public JsonMetricHandler(Uri baseUri, string apiKey, string appKey)
            {
                _baseUri = baseUri;
                _apiKey = apiKey;
                _appKey = appKey;
