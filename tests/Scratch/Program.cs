...
namespace Scratch
{
    ...
    {
        //        [MetricTag] public readonly string Host;
        [MetricTag] public readonly string SomeTagName;
...
//            Host = "bret-host";
    ...
    {
        [MetricTag] public readonly string Thing;
    ...
    {
        [MetricTag] public readonly SomeEnum TagName;
    ...
    {
        [MetricTag] public readonly string Converted;
    ...
    {
        [MetricTag] public readonly string Other;
    ...
    {
        [MetricTag] public readonly SomeEnum Something;
